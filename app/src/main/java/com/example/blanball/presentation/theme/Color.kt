...
val textTertiary = Color(0xFF6E6D80)
...
val semiTransparentBlack = Color(0xCC090910)
val grayBorder = Color(0xFFF2F2F5)
val borderPrimary = Color(0xFFDCDCE2)
val cardShadow = Color(0x3838FB1A)
